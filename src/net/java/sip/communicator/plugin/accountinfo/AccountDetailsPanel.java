...
//                                                    newMiddleNameDetail);
            ...
            catch (ClassCastException | OperationFailedException e1)
            {
    ...
    private class ChangeAvatarActionListener implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            SipCommFileChooser chooser = GenericFileDialog.create(
                null,
                Resources.getString("service.gui.avatar.CHOOSE_ICON"),
    ...
    {
        Resources.getImage("accountInfoDefaultPersonIcon")
        .addToLabel(avatarLabel);
    }
}
