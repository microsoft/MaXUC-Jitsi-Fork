    ...
    extends ExtendedDesktopAccountRegWizard
{
    ...
    public Iterator<Map.Entry<String, String>> getSummary()
    {
        ...
        if (registration.getPresenceType().equals(SipPresenceTypeEnum.DIALOG))
        {
            summaryTable.put(
                Resources.getString("plugin.sipaccregwizz.FORCE_P2P_PRESENCE"),
                Resources.getString("service.gui.NOT_APPLICABLE"));
        }
        else
        {
        ...
        throws OperationFailedException
    {
        ...
        if (serverAddress != null)
        {
            ...
            if (!userName.contains(serverAddress))
        ...
        accountProperties.put("CP_ENABLE",
            Boolean.toString(registration.isCPEnable()));
