    ...
    implements Skinnable
{
     ...
     */
    private static BufferedImageFuture sButtonRolloverBG
        = GuiActivator.getImageLoaderService().getImage(ImageLoaderService.BUTTON_ROLLOVER);
    ...
    public void paint(Graphics g, JComponent c)
    {
                ...
                || bufferIsRollover != model.isRollover())
        {
            ...
            int indentWidth  = 10;
            if(bufferIsRollover){
                BufferedImage buttonRolloverBG = sButtonRolloverBG.resolve();
