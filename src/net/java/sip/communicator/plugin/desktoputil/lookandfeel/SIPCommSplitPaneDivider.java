    ...
    implements Skinnable
{
     ...
     */
    private BufferedImageFuture horizontalDivider
        = GuiActivator.getImageLoaderService().getImage(ImageLoaderService.SPLITPANE_HORIZONTAL);

    /**
     * The vertical divider.
     */
    private BufferedImageFuture verticalDivider
        = GuiActivator.getImageLoaderService().getImage(ImageLoaderService.SPLITPANE_VERTICAL);
    ...
    public void paint(Graphics g)
    {
        ...
        {
            BufferedImage horizontalDivider = this.horizontalDivider.resolve();
        ...
        {
            BufferedImage verticalDivider = this.verticalDivider.resolve();
    ...
    public void loadSkin()
    {
        horizontalDivider
            = GuiActivator.getImageLoaderService().getImage(
                    ImageLoaderService.SPLITPANE_HORIZONTAL);
        verticalDivider
            = GuiActivator.getImageLoaderService().getImage(
                    ImageLoaderService.SPLITPANE_VERTICAL);
    }
}
