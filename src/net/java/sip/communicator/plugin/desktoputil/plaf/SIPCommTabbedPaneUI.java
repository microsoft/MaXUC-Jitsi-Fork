    ...
    implements Skinnable
{
            ...
            FontMetrics metrics)
    {
        ...
        int delta = ScaleUtils.scaleInt(3);
    ...
    protected int calculateTabHeight(int tabPlacement, int tabIndex,
            int fontHeight)
    {
        return super.calculateTabHeight(tabPlacement,
                                        tabIndex,
                                        fontHeight + ScaleUtils.scaleInt(4));
    }
            ...
            Rectangle iconRect, Rectangle textRect, boolean isSelected)
    {
        ...
        if (icon != null)
        {
            iconRect.y = iconRect.y + ScaleUtils.scaleInt(2);
            iconRect.x = tabRect.x + ScaleUtils.scaleInt(7);
        }

        textRect.y = textRect.y + ScaleUtils.scaleInt(2);

        if (icon != null)
            textRect.x = iconRect.x + iconRect.width + ScaleUtils.scaleInt(5);
        else
            textRect.x = textRect.x + ScaleUtils.scaleInt(8);
    }
    ...
    protected void paintCloseIcon(Graphics g, int dx, int dy, boolean isOver)
    {
        ...
        // closeImgB);
        g.drawImage(closeImgI.resolve(), dx, dy + 1, null);
    }
