    ...
    implements Skinnable
{
        ...
        int tabIndex, int x, int y, int w, int h, boolean isSelected)
    {
        ...
        if (isSelected)
        {
            ...
            {
                leftImg = DesktopUtilActivator.getImage(SELECTED_TAB_LEFT_BG).resolve();
                middleImg = DesktopUtilActivator.getImage(SELECTED_TAB_MIDDLE_BG).resolve();
                rightImg = DesktopUtilActivator.getImage(SELECTED_TAB_RIGHT_BG).resolve();

                tabOverlap = TAB_OVERLAP;
            }
            else
            {
                leftImg = DesktopUtilActivator.getImage(TAB_LEFT_BG).resolve();
                middleImg = DesktopUtilActivator.getImage(TAB_MIDDLE_BG).resolve();
                rightImg = DesktopUtilActivator.getImage(TAB_RIGHT_BG).resolve();
            }
        }
        else
        {
