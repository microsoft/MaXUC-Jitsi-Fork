...
public class SIPCommHTMLEditorKit extends HTMLEditorKit
{
    ...
    /**
     * An extended <tt>HTMLFactory</tt> that uses the <tt>ParagraphViewX</tt> to represent
     * paragraphs and <tt>MyComponentView</tt> to represent components.
     */
        ...
        implements ViewFactory
    {
        public View create(Element elem)
        {
            ...
            // Some other kind of View, e.g. ImageView for an IMG tag for an emoji character.
            return view;
        }
    }
