 ...
 * optionally, a <tt>Throwable</tt> stack trace. <tt>LegacyErrorDialog</tt> has an OK
 ...
 */
public class LegacyErrorDialog
    extends SIPCommDialog
    implements ActionListener, HyperlinkListener, Skinnable
{
    private static final long serialVersionUID = 1L;

    /**
     * The <tt>Logger</tt> used by the <tt>LegacyErrorDialog</tt> class and its
     * instances for logging output.
     */
    private static final Logger logger = Logger.getLogger(LegacyErrorDialog.class);
    ...
    protected final JLabel iconLabel =
        DesktopUtilActivator.getImage("service.gui.icons.ERROR_ICON")
            .getImageIcon().addToLabel(new JLabel());
     ...
     * determine whether we should show stack trace in error dialogs. Default is
     * show.
     */
    private static final String showStackTraceDefaultProp =
        DesktopUtilActivator.getResources()
            .getSettingsString("net.java.sip.communicator.SHOW_STACK_TRACE");
    ...
    private static final boolean showStackTrace =
        showStackTraceDefaultProp == null
            || Boolean.parseBoolean(showStackTraceDefaultProp);
     ...
     * {@link #LegacyErrorDialog(Frame, String, String, Throwable)} calls
     * {@link #showOrHideDetails()} and thus <tt>LegacyErrorDialog</tt> defaults to
    ...
    /**
     * The type of this <tt>LegacyErrorDialog</tt>.
     */
    ...
    /**
     * The default <tt>LegacyErrorDialog</tt> displays an error
     */
     ...
     * option. When the user dismisses this dialog the config option will be set
     * to have the value of this checkbox
     */
    ...
    /**
     * Initializes a new <tt>LegacyErrorDialog</tt> with a specific owner
     ...
     */
    public LegacyErrorDialog(Frame owner, String title, String message)
    {
     ...
     *                         box will be displayed which allows the user to
     *                         say whether this dialog should ever be shown
     *                         again
     */
    public LegacyErrorDialog(Frame owner, String title, String message,
        String configOption)
     ...
     */
    public LegacyErrorDialog(Frame owner, String title, String message,
        String configOption, String buttonText)
    {
        super(owner, false);
     ...
     */
    public LegacyErrorDialog(Frame owner, String title, String message,
        ErrorType type, String buttonText)
    {
     ...
     * @param owner   the dialog owner
     */
    public LegacyErrorDialog(String title, String message, Dialog owner)
    {
     ...
     * @param owner        the dialog owner
     */
    public LegacyErrorDialog(String title, String message, String configOption,
        Dialog owner)
    {
     ...
     */
    public LegacyErrorDialog(String title, String message, String configOption,
        String buttonText, Dialog owner)
    {
        super(owner, false);
    ...
    /**
     * Initializes a new <tt>LegacyErrorDialog</tt> with a specific owner
     * <tt>Dialog</tt>, title and message to be displayed and of a specific
     * type.
     *
     * @param title   the title of the error dialog
     * @param message the message to be displayed
     ...
     * @param owner   the dialog owner
     */
    public LegacyErrorDialog(String title, String message, ErrorType type,
        Dialog owner)
    {
     ...
     * @param buttonText   the text to use for the 'OK' button
     */
    private void init(String title, String message, String configOption,
        String buttonText)
    {
        ...
        this.mainPanel.setBorder(BorderFactory.createEmptyBorder(THICK_BORDER,
            THICK_BORDER, THIN_BORDER, THICK_BORDER));

        if (showStackTrace)
        {
            this.stackTraceScrollPane.setBorder(
                BorderFactory.createLineBorder(iconLabel.getForeground()));
        ...
        messageArea
            .setSize(new Dimension(MAX_MSG_PANE_WIDTH, MAX_MSG_PANE_HEIGHT));
        messageArea.setPreferredSize(new Dimension(MAX_MSG_PANE_WIDTH,
            messageArea.getPreferredSize().height));
        messageArea.setForeground(new Color(DesktopUtilActivator.getResources()
        ...
        if (configOption != null)
        {
            ...
            checkBox = new JCheckBox(DesktopUtilActivator.getResources()
            ...
            checkBox.setForeground(new Color(DesktopUtilActivator.getResources()
                .getColor("service.gui.DARK_TEXT")));
        ...
        // Some dialogs have an action button, so create it in case, but set it
        // invisible
    ...
    /**
     * Handles the <tt>ActionEvent</tt>. Depending on the user choice sets the
     * return code to the appropriate value.
     *
    ...
    /**
     * Close the LegacyErrorDialog. This function is invoked when user presses the
     * Escape key.
     *
    ...
    /**
     * Update the LegacyErrorDialog when the user clicks on the hyperlink.
     *
    ...
    public void loadSkin()
    {
        ...
        DesktopUtilActivator.getImage(icon).getImageIcon()
    ...
    /**
     * messageArea in the LegacyErrorDialog changed from JEditorPane to JTextArea.
     * JTextArea shows HTML tags as they are without parsing them. Here we
     * replace the <br>
     * tag with a newline to add line breaks to the error message.
     *
