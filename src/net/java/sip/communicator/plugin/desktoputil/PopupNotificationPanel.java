    ...
    implements Skinnable
{
    ...
    private PopupNotificationPanel(String titleString)
    {
        ...
        notifTitle.setForeground(
            new Color(DesktopUtilActivator.getResources().getColor("service.gui.DARK_TEXT"))
            );
        ScaleUtils.scaleFontAsDefault(notifTitle);
    ...
    {
        DesktopUtilActivator.getResources().getImage(
            "service.gui.SIP_COMMUNICATOR_LOGO").addToLabel(notifTitle);

        notifClose.setBackgroundImage(DesktopUtilActivator.getResources()
                .getBufferedImage("service.gui.lookandfeel.CLOSE_TAB_ICON"));
    }
}
