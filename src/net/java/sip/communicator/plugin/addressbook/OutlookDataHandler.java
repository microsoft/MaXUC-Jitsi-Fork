                  ...
                  OperationSetServerStoredUpdatableContactInfo
{
    ...
    private void Initialize() throws Exception
    {
        ...
        Initialize(server.getPort(), logs[0], logs[1], getCrashDir().getAbsolutePath());
    }
    ...
    private static String[] rollLogFiles()
    {
        ...
        for(int i = 0; i < LOGGING_LOG_COUNT; i++)
        {
            ...
            {
                serverLogFiles[i]
                    = AddressBookProtocolActivator.getFileAccessService().getPrivatePersistentFile(
                        LOGGING_DIR_NAME
                        + File.separator
    ...
    private boolean restartServerIfRequired(Timer timer)
    {
        ...
        boolean alive = CheckServerIsAlive();
