    ...
    extends SIPCommDialog
{
    ...
    /**
     * The button to accept certificate.
     */
    JButton mContinueButton = null;
    ...
    private void init()
    {
        ...
        JLabel imgLabel = R.getImage("service.gui.icons.CERTIFICATE_WARNING").addToLabel(
            new JLabel());
        ...
        mContinueButton = new JButton(
            R.getI18NString("service.gui.CONTINUE_ANYWAY"));

        mContinueButton.addActionListener(new ActionListener() {
        ...
        secondButonPanel.add(mContinueButton);
    ...
    private void actionShowCertificate()
    {
        ...
        else
        {
            ...
            // The text color must be set to black as the background color is
            // not brandable.
