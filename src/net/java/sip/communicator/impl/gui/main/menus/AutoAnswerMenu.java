    ...
    implements Skinnable
{
    ...
    {
        GuiActivator.getImageLoaderService().getImage(ImageLoaderService.CALL_16x16_ICON)
        .getImageIcon()
        .addToButton(this);
    }
        ...
        ImageObserver imageObserver)
    {
        ...
        if(isAutoAnswerEnabled(providerService))
            left = GuiActivator.getImageLoaderService().getImage(
                                          ImageLoaderService.AUTO_ANSWER_CHECK).resolve();

        if(customProviderImage == null)
            customProviderImage = providerService.getProtocolIcon()
        ...
        private void initComponents()
        {
            ...
            if(opSetAdvanced != null)
            {
                ...
                descriptionLabel.setFont(descriptionLabel.getFont().deriveFont(
                    ScaleUtils.getScaledFontSize(8f)));
