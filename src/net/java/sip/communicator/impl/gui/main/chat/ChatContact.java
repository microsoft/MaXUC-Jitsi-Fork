...
public abstract class ChatContact<T>
{
     ...
     * <code>ImageIcon</code>.
     */
    private ImageIconFuture avatar;

    /**
     * The avatar image corresponding to the source contact in the form of an
     * array of bytes.
     */
    private BufferedImageFuture avatarBytes;
     ...
     * of multi user chat contact returns null
     */
    public ImageIconFuture getAvatar()
    {
        BufferedImageFuture avatarBytes = getAvatarBytes();
        ...
        if ((this.avatar == null)
            ...
            this.avatar
                    = avatarBytes.getScaledRoundedIcon(
                            AVATAR_ICON_WIDTH,
                            AVATAR_ICON_HEIGHT);
        return this.avatar;
    }
     ...
     */
    protected abstract BufferedImageFuture getAvatarBytes();
