                ...
                Skinnable
{
    ...
    private JLabel iconLabel = GuiActivator.getImageLoaderService()
        .getImage(ImageLoaderService.AUTHORIZATION_ICON)
        .getImageIcon()
     ...
     * received.
     */
    public AuthorizationResponseDialog( AbstractMainFrame mainFrame,
                                        Contact contact,
