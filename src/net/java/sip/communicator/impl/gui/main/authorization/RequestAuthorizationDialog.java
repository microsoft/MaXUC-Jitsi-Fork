                ...
                Skinnable
{
    ...
    private JLabel iconLabel = GuiActivator.getImageLoaderService().getImage(
        ImageLoaderService.AUTHORIZATION_ICON)
        .getImageIcon()
     ...
     */
    public RequestAuthorizationDialog(  AbstractMainFrame mainFrame,
                                        Contact contact,
                                        AuthorizationRequest request)
    {
        ...
        this.infoTextArea.setFont(Constants.FONT.deriveFont(
            Font.BOLD, ScaleUtils.getDefaultFontSize()));
