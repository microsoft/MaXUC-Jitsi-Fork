    ...
    extends ExtensionElementProvider<RemoteControlExtension>
{
    ...
    public static final String NAMESPACE =
        "https://jitsi.org/protocol/inputevt";
     ...
     */
    @Override
    public RemoteControlExtension parse(XmlPullParser parser,
                                        int initialDepth,
        ...
        throws XmlPullParserException, IOException, SmackParsingException
    {
        ...
        if(result == null)
        {
            /* we are not allowed to return null because that will cause the
             * parser to malfunction.
             */
