 ...
 */
public class GeolocationExtensionElement implements ExtensionElement
{
    ...
    {
        return GeolocationExtensionElementProvider.ELEMENT_NAME;
    }
    ...
    {
        return GeolocationExtensionElementProvider.NAMESPACE;
    }
    ...
    {
        this.bearing = new Float(bearing);
    }
    ...
    {
        this.error = new Float(error);
    }

    /**
     * The number or name of a particular floor in a building.
     *
    ...
    /**
     * Sets the number or name of a particular floor in a building.
     *
