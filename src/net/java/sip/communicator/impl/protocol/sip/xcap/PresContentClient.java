...
public interface PresContentClient
{
     ...
     */
    String CONTENT_TYPE = "application/vnd.oma.pres-content+xml";

    /**
     * Pres-content namespace
     */
    String NAMESPACE = "urn:oma:xml:prs:pres-content";

    /**
     * Pres-content uri format
     */
    String DOCUMENT_FORMAT = "oma_status-icon/users/%1s/%2s";
