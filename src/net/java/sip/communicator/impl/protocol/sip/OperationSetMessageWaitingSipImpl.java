...
import net.java.sip.communicator.service.insights.values.SipValueInfo;
                ...
                RegistrationStateChangeListener
{
        ...
        int unreadMessages)
    {
        ...
        SipActivator.getInsightsService().logEvent(InsightsEventHint.SIP_MESSAGE_WAITING.name(),
                                                  Map.of(SipParameterInfo.MESSAGE_TYPE.name(), SipValueInfo.VOICEMAIL));
