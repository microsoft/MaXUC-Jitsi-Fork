    ...
    extends EventObject
{
    ...
    /**
     * Returns a String representation of this SystrayPopupMessageEvent.
     *
     * @return  A String representation of this SystrayPopupMessageEvent.
     */
    public String toString()
    {
        return getClass().getName() + "[source=" + source + ",tag=" + tag + "]";
    }
}
