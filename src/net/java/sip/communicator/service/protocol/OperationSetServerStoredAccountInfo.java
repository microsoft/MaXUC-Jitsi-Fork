    ...
    extends OperationSet
{
     ...
     */
    boolean isDetailClassSupported(
            Class<? extends GenericDetail> detailClass);
     ...
     * to register.
     */
    void addServerStoredDetailsChangeListener(
     ...
     * to unregister.
     */
    void removeServerStoredDetailsChangeListener(
            ServerStoredDetailsChangeListener listener);
}
