 ...
 * <p>
 * All details have a value and a detailDisplayName as well as get methods that
 ...
 * <p>
 * When choosing a class for the value of your detail, make sure it has a well
 * defined (overridden) equals() method, otherwise the GenericDetail equals()
 * will break - see method for details.
 * <p>
...
public class ServerStoredDetails
{
    ...
    public static class GenericDetail
    {
         ...
         */
        public void setDetailValue(Object newValue)
        {
            value = newValue;
        }
        ...
        /**
         * TODO: If you only override equals, but not hashCode, that can cause
         *  problems with hash-based data structures (HashSet, HashMap, etc.).
         *   Ideally, we would override the hashCode method of this object also.
         *    See the Java documentation for Object.hashCode and Object.equals.
         *
         * Compares two GenericDetails according to their
         * DetailDisplayName and Value.
         *
         * N.B. This works so long as the value Object has a meaningful equals()
         * method. If we rely on the default Object.equals(), we'd just be
         * comparing memory addresses, which is useless.
         *
         * We don't police this in this method, but rely that each class
         * extending GenericDetail will use a sensible type for the value Object,
...
//------------------------- phones --------------------------------------------
    ...
    public static class PhoneNumberDetail extends StringDetail
    {
        ...
        public PhoneNumberDetail(String detailDisplayName, String number)
        {
            super(detailDisplayName, number);
        }
...
//--------------------------- Binary -------------------------------------------
    ...
    {
        public ImageDetail(String detailDisplayName, BufferedImageFuture image)
        {
        ...
        {
            return (BufferedImageFuture) getDetailValue();
        }
    }
...
//------------------------------- E-Mails  ------------------------------------
    ...
    public static class EmailAddressDetail extends StringDetail
    {
        ...
        public EmailAddressDetail(String detailDisplayName, String value)
        {
            super(detailDisplayName, value);
        }
