...
public class CallPeerState
{
     ...
     * </p>
     */
    public static final String _ON_HOLD_MUTUALLY = "On Hold";
    /**
     * The constant value indicating that the state of a call peer is
    ...
    /**
     * Determines whether a specific <tt>CallPeerState</tt> value
     * signals that the call is connecting.
     *
     * @param state
     *            the <tt>CallPeerState</tt> value to be checked
     *            whether it signals connecting.
     * @return <tt>true</tt> if the specified <tt>state</tt> signals a call
     *         is connecting; <tt>false</tt>, otherwise
     */
    public static boolean isConnecting(CallPeerState state)
    {
        return CallPeerState.CONNECTING.equals(state)
                || CallPeerState.CONNECTING_INCOMING_CALL.equals(state)
                || CallPeerState.CONNECTING_WITH_EARLY_MEDIA.equals(state);
    }

    /**
     * Determines whether a specific <tt>CallPeerState</tt> value
     * signals that the call is ringing.
     *
     * @param state
     *            the <tt>CallPeerState</tt> value to be checked
     *            whether it signals ringing.
     * @return <tt>true</tt> if the specified <tt>state</tt> signals a call
     *         is connecting; <tt>false</tt>, otherwise
     */
    public static boolean isRinging(CallPeerState state)
    {
        return CallPeerState.ALERTING_REMOTE_SIDE.equals(state);
    }
     ...
     */
    @VisibleForTesting
    public CallPeerState(String callPeerState,
