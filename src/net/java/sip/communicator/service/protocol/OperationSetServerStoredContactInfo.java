    ...
    extends OperationSet
{
     ...
     * contact.
     */
    Iterator<GenericDetail> getAllDetailsForContact(Contact contact);
     ...
     */
    Iterator<GenericDetail> requestAllDetailsForContact(
    ...
    interface DetailsResponseListener
    {
         ...
         */
        void detailsRetrieved(Iterator<GenericDetail> detailIterator);
    }
}
