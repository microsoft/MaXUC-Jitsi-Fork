...
public abstract class Call
{
    ...
    /*
     * The time the user thinks this call started.
     */
    private long userPerceivedCallStartTime;
    ...
    /**
     * Fires a <tt>CallChangeEvent</tt> for a change with this class as
     * <tt>sourceCall</tt>.
     *
     * @param type the event type
     * @param state the state of the media - takes values from CallChangeEvent
     */
    public void updateCallState(String type, Object state)
    {
        fireCallChangeEvent(type, null, state);
    }
                                        ...
                                        CallPeerChangeEvent cause)
    {
        ...
        for (CallChangeListener listener : listeners)
            if(type.equals(CallChangeEvent.CALL_STATE_CHANGE) ||
               type.equals(CallChangeEvent.INBOUND_PACKET_LOSS_CHANGE) ||
               type.equals(CallChangeEvent.OUTBOUND_PACKET_LOSS_CHANGE) ||
               type.equals(CallChangeEvent.CALL_MEDIA_STATE_CHANGE))
    ...
    /*
     * Set the time the user thinks the call has started
     *   - when they press "Answer" for incoming calls
     *   - when the other party answers on outgoing calls
     */
    public void setUserPerceivedCallStartTime(long time)
    {
        logger.info("Call starting at time " + time);
        userPerceivedCallStartTime = time;
    }
    /*
     * Set the time the user thinks the call has started
     *   - when they press "Answer" for incoming calls
    ...
    public long getUserPerceivedCallStartTime()
    {
        return userPerceivedCallStartTime;
    }
}
