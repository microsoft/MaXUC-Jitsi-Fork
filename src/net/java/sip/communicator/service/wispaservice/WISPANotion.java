 ...
 * WISPAActions of type NOTION. Unlike Motions, these are performed by Node and
 * not written to the redux store.
 *
 * To ensure consistency in the content of the Notion requests, we store all
 * valid notion values that can be sent in this simple enum, which is accessible
