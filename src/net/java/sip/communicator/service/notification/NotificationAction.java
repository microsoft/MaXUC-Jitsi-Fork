...
public abstract class NotificationAction
{
    ...
    /**
     * The UI notification action type indicates that the representations of the
     * number of outstanding notifications in the UI should be updated.
     */
    public static final String ACTION_DISPLAY_UI_NOTIFICATIONS = "UINotificationAction";
