...
public interface NotificationService
{
    ...
    /**
     * Add a listener to be informed whenever a Notification Handler is added.
     *
     ...
     * Notification Handler is added
     */
    interface HandlerAddedListener
    {
        /**
         * Called when a Notification Handler is added
         *
         * @param handler the new handler
         */
        void onHandlerAdded(NotificationHandler handler);
    }
