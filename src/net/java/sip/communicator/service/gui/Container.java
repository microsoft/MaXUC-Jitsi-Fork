...
public class Container
{
     ...
     */
    public static final Container CONTAINER_SEARCH_EAST
             = new Container("CONTAINER_SEARCH_EAST");
    ...
    /**
     * Chat window "tools menu" container
     */
    public static final Container CONTAINER_CHAT_TOOLS_MENU
        = new Container("CONTAINER_CHAT_TOOLS_MENU");
    /**
