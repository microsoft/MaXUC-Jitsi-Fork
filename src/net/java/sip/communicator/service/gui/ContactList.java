            ...
            MetaContactQueryListener
{
     ...
     * @param filter the <tt>ContactListFilter</tt> to set as the current
     * filter
     */
    void setCurrentFilter(ContactListFilter filter);
     ...
     */
    FilterQuery applyCurrentFilter();
     ...
     * @param addToSelection whether this contact should be added to the
     * current selection, or should be the sole selected contact
     */
    void setSelectedContact(UIContact uiContact, boolean addToSelection);
    ...
    /**
     * Adds a selection listener to this contact list
     */
    void addSelectionListener(ContactListSelectionListener listener);
}
