...
public class InsightEvent
{
    ...
    public InsightEvent(String eventType)
    {
        this(eventType, null, (Map<String, Double>) null);
    }

    public InsightEvent(String eventType, Map<String, String> properties)
    {
        this(eventType, properties, null);
    }

    public InsightEvent(String eventType, String propName, String propValue)
    {
        this(eventType, Map.of(propName, propValue), null);
    }

    public InsightEvent(String eventType, String metricName, Double metricValue)
    {
        this(eventType, null, Map.of(metricName, metricValue));
    }

    public InsightEvent(String eventType, Map<String, String> properties, Map<String, Double> metrics)
    {
