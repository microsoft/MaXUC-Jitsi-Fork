 ...
 */
#ifndef _NET_JAVA_SIP_COMMUNICATOR_PLUGIN_ADDRESSBOOK_MSOUTLOOKADDRBOOKCONTACTSOURCESERVICE_H_
#define _NET_JAVA_SIP_COMMUNICATOR_PLUGIN_ADDRESSBOOK_MSOUTLOOKADDRBOOKCONTACTSOURCESERVICE_H_
...
HRESULT MsOutlookAddrBookContactSourceService_MAPIInitializeCOMServer
    (JavaLogger* logger, const char* logFile, int port);

void MsOutlookAddrBookContactSourceService_MAPIUninitialize(void);

void MsOutlookAddrBookContactSourceService_MAPIUninitializeCOMServer(JavaLogger* logger);
